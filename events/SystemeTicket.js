...
module.exports = {
	...
	const row = new MessageActionRow()
        ...
        let catégorie = "1223842150031294566" // Categoria onde será criado o ticket
        let roleStaff = interaction.guild.roles.cache.get('1220559663758708797') // Cargo que respondera o ticket
        ...
        if (interaction.customId == "select") {
            ...
            if (interaction.values[0] == "compra") {
                interaction.guild.channels.create(`💸・Compra ${interaction.user.username}`, {
                    ...
                    .setTitle('Compras | Brasil City') // Nome do seu servidor
                ...
                interaction.guild.channels.create(`📞・Suporte ${interaction.user.username}`, {
                    ...
                    .setTitle('Suporte | Brasil City') // Nome do seu servidor 
                ...
                interaction.guild.channels.create(`❓・Duvida de ${interaction.user.username}`, {
                    ...
                    .setTitle('Duvidas | Brasil City') // Nome do seu servidor
                ...
                interaction.guild.channels.create(`🐛・Bug de ${interaction.user.username}`, {
                    ...
                    const embed = new MessageEmbed()
                    .setTitle('Bugs | Brasil City') // Nome do seu servidor
                ...
                interaction.guild.channels.create(`🚨・Denúncia de ${interaction.user.username}`, {
                    ...
                    const embed = new MessageEmbed()
                    .setTitle('Denúncia | Brasil City') // Nome do seu servidor
